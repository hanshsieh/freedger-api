 ...
 * 
 * <p>This client provides access to historical exchange rate data from the
 * OpenExchangeRates API. Currently supports the /historical/*.json endpoint.</p>
 * 
...
public class OpenExchangeRatesHttpClient {
     ...
     * 
     * <p>Returns the last exchange rate values published for the given UTC date
     * (up to and including 23:59:59 UTC), except for the current UTC date which
     * returns the most recent rates available.</p>
     * 
     * <p>Note: Historical rates are available from 1st January 1999 onwards.</p>
     * 
     * <p>Note: Changing the base currency and requesting specific symbols require
     * a Developer, Enterprise or Unlimited plan.</p>
     * 
     * <p>Example usage:</p>
     * <pre>
     ...
     */
    public HistoricalRatesResponse getHistoricalRates(HistoricalRatesRequest request) throws IOException {
        try {
            // Format the date
        ...
        try {
            return httpClient.execute(request, response -> {
                ...
                if (statusCode >= 200 && statusCode < 300) {
                    ...
                    throw new IOException("Request failed with status code " + statusCode + ": " + responseBody);
                }
            });
        } catch (Exception e) {
