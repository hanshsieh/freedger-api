 ...
 * 
 * <p>Use the builder pattern to construct requests:</p>
 * <pre>
...
public class HistoricalRatesRequest {
    ...
    /**
     * Optional base currency (3-letter ISO currency code).
     * Requires Developer, Enterprise or Unlimited plan.
     */
    private final String base;
    
    /**
     * Optional list of currency codes to limit the response.
     * Requires Developer, Enterprise or Unlimited plan.
     */
    ...
    public static class Builder {
         ...
         * 
         * <p>Note: Requires Developer, Enterprise or Unlimited plan.</p>
         * 
